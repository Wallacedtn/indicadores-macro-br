...
# Tabela PIM-PF (indústria – índice e variação da produção física)
IBGE_TABELA_PIM = 8888
...
def _buscar_serie_sgs_cached(
    ...
    Agora com retry e timeout mais robusto.
    """
    url = (
...
def buscar_serie_sgs(
    ...
    Usa cache em memória para evitar múltiplos hits
    na mesma série na mesma execução.
    """
...
def _buscar_serie_mensal_ibge_cached(
    ...
    if col_periodo is None:
        # fallback mais comum nas APIs novas
...
# =============================================================================
# ATIVIDADE ECONÔMICA – PMC (VAREJO) – SÉRIES OFICIAIS (p/last60)
# =============================================================================
...
# =============================================================================
# ATIVIDADE ECONÔMICA – PMS (SERVIÇOS) – SÉRIES OFICIAIS (p/last60)
# =============================================================================
...
# =============================================================================
# ATIVIDADE ECONÔMICA – PIM-PF (INDÚSTRIA) – SÉRIES OFICIAIS (p/last60)
# =============================================================================
...
# =============================================================================
# RESUMOS TRIPLOS (PMC / PMS / PIM-PF)
# =============================================================================
...
# =============================================================================
# CÂMBIO – RESUMO (com níveis 12m e 24m)
# =============================================================================
...
def buscar_focus_expectativa_anual(
    ...
    Usa o endpoint: ExpectativasMercadoAnuais (API Olinda do BCB).
    """
...
def montar_tabela_cdi() -> pd.DataFrame:
    """
    Tabela institucional do CDI em uma única linha:

    Colunas:
    - Data ref.
    - Nível diário (última taxa, em % a.d.)
    - CDI no mês (acumulado até a última data)
    - CDI no ano (YTD)
    - CDI em 12 meses (rolling 12m)
    """
    linhas: List[Dict[str, str]] = []
    ...
    try:
        ...
        # --- CDI acumulado no mês (até a última data) ---
        df_mes = df[
        ...
        # --- CDI acumulado em 12 meses (rolling) ---
...
def montar_tabela_atividade_economica() -> pd.DataFrame:
    ...
    - Indústria (PIM-PF): idem, com tabela 8888.
    """
    linhas: List[Dict[str, str]] = []
...
def montar_tabela_focus() -> pd.DataFrame:
    """
    Expectativas de mercado (Focus) para ano corrente e próximo:

    - IPCA
    - PIB Total
    - Selic (meta over – fim de ano)
